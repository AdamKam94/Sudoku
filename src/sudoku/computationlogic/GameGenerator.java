...
public class GameGenerator {
    ...
    /**
     * 1. Generate new 9x9 array.
     * 2. For each value in the range 1-9 allocate that value 9 times based on following constraints:
    ...
    private static int[][] getSolvedGame() {
        ...
        for (int value = 1; value<= GRID_BOUNDARY; value++){
            // allocations refers to the number of times in which a square has been given value.
            int allocations = 0;
     ...
     * forward way to check if puzzle is still solvable after removing the tiles, beyond using another algorithm
     * to attempt to re-solve the problem.
     *
     * 1. copy values of solvedGame to new Array (make into helper)
    ...
    private static int[][] unsolveGame(int[][] solvedGame) {
        ...
        //note: not actually solvable until the game algorithm below finishes!
